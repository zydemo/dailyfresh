    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gtitle', models.CharField(max_length=35, verbose_name='商品名称')),
                ...
                ('gpic', models.ImageField(blank=True, null=True, upload_to='article_img/', verbose_name='商品图片')),
                ('gcontent', DjangoUeditor.models.UEditorField(blank=True, verbose_name='详细介绍')),
            ],
            options={
                'verbose_name': '商品信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ttitle', models.CharField(max_length=20, verbose_name='分类名称')),
                ('isDelete', models.BooleanField(default=False, verbose_name='是否删除')),
            ],
            options={
                'verbose_name': '分类信息',
